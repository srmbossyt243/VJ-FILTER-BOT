...
API_ID = int(environ.get('API_ID', '24845159'))
API_HASH = environ.get('API_HASH', 'b75fc3055203def7fa553e293be94896')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/96a52f6d974c1480828da-9c712f1a53cc7d7a39.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002318844685'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002480305689 -1002166425802').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002391677566') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002480305689 -1002166425802')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://srmbossyt2:Zi4GGiLpW2LdHBSb@cluster0.eyefk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "srmbossyt2")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'srmmovies')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/srm_movies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'srm_request_movie') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/rahul_srm_official')
